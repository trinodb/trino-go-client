...
func TestSerial(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "float32 with inexact binary representation", value: float32(0.1), want: "REAL '0.1'"},
		{name: "float32 large", value: float32(3.4028235e38), want: "REAL '3.4028235e+38'"},
		{name: "float64", value: float64(1.5), want: "DOUBLE '1.5'"},
		{name: "float64 with inexact binary representation", value: 0.1, want: "DOUBLE '0.1'"},
		{name: "float64 small", value: 1e-7, want: "DOUBLE '1e-07'"},
		{name: "float64 integer", value: float64(100), want: "DOUBLE '100'"},
		{name: "float64 negative zero", value: math.Copysign(0, -1), want: "DOUBLE '-0'"},
		{name: "float64 NaN", value: math.NaN(), want: "DOUBLE 'NaN'"},
		{name: "float64 positive infinity", value: math.Inf(1), want: "DOUBLE 'Infinity'"},
		{name: "float64 negative infinity", value: math.Inf(-1), want: "DOUBLE '-Infinity'"},
		{name: "float32 negative infinity", value: float32(math.Inf(-1)), want: "REAL '-Infinity'"},
