...
func TestDsnClientTags(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			dsnSuffix:    "?clientTags=foo+%2520%3Bbar%3Dtest%3Bbaz%23tag&source=multiple-tags-test-special-characters",
...
func TestParametersClientTags(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "Single tag",
			dsnSuffix:    "?source=query-parameter-single-tag-test",
			Tags:         "single-tag",
		...
		{
			name:         "Multiple tags with special characters",
			dsnSuffix:    "?source=query-parameter-multiple-tags-test",
		...
		},
		{
			...
			dsnSuffix:    "?clientTags=foo+%2520%3Bbar%3Dtest%3Bbaz%23tag&source=query-parameter-override-tags",
